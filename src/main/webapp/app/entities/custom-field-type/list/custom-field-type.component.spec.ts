...
describe('Component Tests', () => {
  describe('CustomFieldType Management Component', () => {
    let comp: CustomFieldTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustomFieldTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.customFieldTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
