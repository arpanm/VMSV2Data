...
describe('Component Tests', () => {
  describe('JobTemplate Management Component', () => {
    let comp: JobTemplateComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JobTemplateComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jobTemplates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
