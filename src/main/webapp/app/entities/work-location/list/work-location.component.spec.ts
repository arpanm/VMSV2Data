...
describe('Component Tests', () => {
  describe('WorkLocation Management Component', () => {
    let comp: WorkLocationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WorkLocationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
