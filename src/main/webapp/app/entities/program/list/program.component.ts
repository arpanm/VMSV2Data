...
export class ProgramComponent implements OnInit {
  ...
  constructor(protected programService: ProgramService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.programs = [];
    ...
    this.programService
      ...
      .subscribe(
        (res: HttpResponse<IProgram[]>) => {
          ...
          this.paginatePrograms(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
