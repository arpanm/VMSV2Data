...
class CustomFieldTypeResourceIT {
    ...
    private static final CustomFieldDataType DEFAULT_TYPE = CustomFieldDataType.Text;
    private static final CustomFieldDataType UPDATED_TYPE = CustomFieldDataType.Text;
    ...
    void createCustomFieldType() throws Exception {
        ...
        assertThat(testCustomFieldType.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testCustomFieldType.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testCustomFieldType.getLabel()).isEqualTo(DEFAULT_LABEL);
        assertThat(testCustomFieldType.getPlaceholder()).isEqualTo(DEFAULT_PLACEHOLDER);
        assertThat(testCustomFieldType.getIsMandatory()).isEqualTo(DEFAULT_IS_MANDATORY);
    ...
    void putNewCustomFieldType() throws Exception {
        ...
        assertThat(testCustomFieldType.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testCustomFieldType.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testCustomFieldType.getLabel()).isEqualTo(UPDATED_LABEL);
        assertThat(testCustomFieldType.getPlaceholder()).isEqualTo(UPDATED_PLACEHOLDER);
        assertThat(testCustomFieldType.getIsMandatory()).isEqualTo(UPDATED_IS_MANDATORY);
